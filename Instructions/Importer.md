...
- Entries will be imported to the location specified under **Settings → Daily notes**.
	- If you have multiple entries per day, follow the instructions under [Multiple or nested daily notes](./Multiple%20or%20nested%20daily%20notes.html) before importing your journal.
